...
namespace Lab07.Task2.WinAsynchDelegate
{
    public partial class Form1 : Form
    {
        ...
        {
            TimeConsumingMethodeDelegate del = new TimeConsumingMethodeDelegate(TimeConsumingMethod);
        ...
        private delegate void TimeConsumingMethodeDelegate(int seconds);
